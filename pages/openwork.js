  ...
  return (
    <>
      ...
      <div className="openwork-page">
        ...
        {/* Price Card */}
        <div className="openwork-card price-card">
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="price-source">via {marketData.source || 'Uniswap'}</div>
            </>
          ) : (
            <>
        ...
        {/* Actions */}
        <div className="openwork-card actions-card">
          <button 
        ...
        {/* Token Info */}
        <div className="openwork-card info-card">
          <h3>Token Info</h3>
